...
The first thing you will need to view this open source project is unreal engine v 4.25 which can be acquired here (this is a launcher for unreal where you can then select and install the required version):  
